...
function SetCursorTissue(tissue_change) {
    ...
    fetch(`./Tissues/${allTissues[cursor_tissue_seri]}.json`)
        ...
        .then(data => {
            ...
            switch (cursor_tissue_pos) {
                ...
                case 2:
                    playground.cursor_tissue.data.transpose();
                            ...
                            console.log(playground.cursor_tissue.data);
            ...
            // console.log(cursor_tissue_pos, Math.floor(cursor_tissue_pos / 2), cursor_tissue_pos & 1);
            // console.log(playground.cursor_tissue);
            // playground.cursor_tissue.data.flip();
